...
public class TileRenderIndustrialCokeOven extends TileEntitySpecialRenderer {
  private static final IModelCustom model = ClientUtils.getModel(ModInfo.MOD_ID + ":models/cokeOven.obj");
  ...
  public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
    if (tile.getBlockMetadata() == 1 || tile.getBlockMetadata() == 2) {
      ...
      double lavaWidth = (lava.getMaxU() - lava.getMinU()) / lava.getIconWidth();
      for (int i = 0; i < 4; i++) {
